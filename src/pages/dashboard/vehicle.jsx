    ...
    return (
        <Layout title="Vehicle">
            ...
            <div className="flex items-center w-full justify-between  pb-4 bg-white dark:bg-gray-900 pt-6 px-6">
                    ...
                    <div className="relative">
                        <button onClick={toggleAddModal} className="btn bg-slate-900 border">Add Vehicle</button>
                    ...
                    <tbody>
                        <tr className="bg-white border-b dark:bg-gray-800  hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <img className="w-10 h-10 rounded-full" src={require("../../assets/images/banner.png")} alt="Jese image" />
                                <div className="pl-3">
